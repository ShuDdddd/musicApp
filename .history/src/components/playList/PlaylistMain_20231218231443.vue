        ...
        <div class="list_hd">
          ...
          <div class="list_info">
            ...
            <div class="operation">
              ...
              <el-button icon="el-icon-link">({{playListMes.shareCount | millionFormat}})</el-button>
              <el-button icon="el-icon-download">下载</el-button>
              <el-button icon="el-icon-s-comment">评论({{playListMes.commentCount | millionFormat}})</el-button>
            </div>
        ...
        <div class="list_bd">
          <div class="list_bd_title">
            ...
            <div class="play_count">
              播放：
              <strong>{{playListMes.playCount}}</strong>次
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    async getListInfo () {
      ...
      const { data: dynamic } = await this.$http.get('playlist/detail/dynamic', { params: { id: this.id } })
      if (res.code !== 200) {
