...
<template>
      <el-container>
        <el-header>
          <div class="mod_logo">
            <img class="logo" src="../assets/img/flower.png">
            <span>网易云音乐</span>
          </div>
          <!--头部导航栏-->
          ...
          <!--登录对话框组件-->
          <LoginDialog ref="loginDialog" v-if="isLogin"/>
        </el-header>
        <!--主内容-->
        <el-main>
            <DiscoverNav ref="discoverMenu"
                          :currentPath="activePath"></DiscoverNav>
  ...
  export default {
    ...
    methods: {
      ...
      showLogDia () {
        ...
        this.isLogin = true
        this.$refs.loginDialog.getErweima()
      },
      // 获取登录状态
...
<style scoped>
  ...
  .el-header {
    ...
    border-bottom: #f18a92 1px solid;
    color: white;
    line-height: 60px;
    align-items: center;
